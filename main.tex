...
% \input{P1/Function Generator dan Osiloskop.tex}
% \input{P2/(ADC) Analog to Digital Converter.tex}
% \input{P3/(DAC) Digital to Analog Converter.tex}
% \input{P4/Digital Filter.tex}
 \input{P5/Fourier Transform.tex}
